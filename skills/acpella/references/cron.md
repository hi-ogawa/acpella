...
```bash
acpella exec /cron delete morning-check
acpella exec '/cron add morning-check 0 10 * * 1-5 --session tg-123456789 -- Check the project state and report anything urgent.'
```
